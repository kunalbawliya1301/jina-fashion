...
export default function HeroWireframe({ navigate }: Props) {
  return (
    <section className="relative h-auto lg:h-[calc(100svh-5rem)] lg:min-h-[620px] overflow-hidden bg-custom-bg animate-fade-in" aria-label="Jina Fashion hero">
      <div className="mx-auto flex h-full w-full max-w-[1280px] items-center px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-6">
        <div className="grid w-full h-full grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-x-12 lg:gap-y-0 items-center">
          
          {/* Left Text details */}
          <div className="relative z-10 flex flex-col justify-center gap-4 lg:gap-6 lg:col-span-5 h-full py-2">
            ...
            <div className="mt-2 grid grid-cols-3 py-2">
              {[
                ...
                <div key={number} className={`px-2 sm:px-4 ${index > 0 ? 'border-l border-border-custom' : ''}`}>
                  ...
                  <div className="font-semibold text-[11px] sm:text-xs text-primary tracking-wide font-sans">{title}</div>
          ...
          {/* Right Image Collage */}
          <div className="relative lg:col-span-7 lg:col-start-6 lg:row-start-1 h-full flex items-center">
            <div className="grid grid-cols-12 gap-2.5 sm:gap-4 w-full h-full lg:max-h-[calc(100svh-10rem)]">
              <div className="col-span-7 row-span-2 min-h-[320px] sm:min-h-[440px] lg:min-h-0">
                <ImgBox 
                  className="h-full w-full" 
                  src="/hero_look_01.png" 
                  label="HERO LOOK 01" 
              ...
              <div className="col-span-5 min-h-[150px] sm:min-h-[210px] lg:min-h-0">
                <ImgBox 
